...
# Sample call: python generateInput_getAllCliques.py all_either_model.tsv MM+TSCS+Exp+Abun+Loc+Kaggle_features_all_either_model_predictions_rf_400 cutoff ./results/

import copy
import sys


def feedOutputs_getAllCliques(pairsInfoFilename, pairsPredictionsFilename, cutoff, outputPATH):
    TOP_CUTOFF = cutoff
...
def main(args):
    ...
    feedOutputs_getAllCliques(pairsInfoFilename, pairsPredictionsFilename, cutoff, outputPATH)
